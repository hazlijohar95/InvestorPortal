...
async function upsertUser(
  ...
  // Determine user type based on email domain or specific logic
  let userType = "investor"; // Default to investor
  
  // If email contains cynco.com domain, make them admin
  if (claims["email"] && claims["email"].includes("@cynco.com")) {
    userType = "admin";
  }
